	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="card card_min618">
			<div class="card-body">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<a href="<?php echo base_url('project/add') ?>" class="btn btn-sm btn-success"><i class="fas fa-plus-circle"></i> Add New Project/Program</a>
					</div>
						...
						<form class="row row-cols-lg-auto g-3 align-items-center">
						  ...
						  <div class="col-12">
						    ...
						    <select class="form-select" id="inlineFormSelectPref">
						      ...
						      <option value="2">Proponent</option>
						    </select>
						  </div>
						  <div class="col-12">
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr>
										...
										<td>SAMPLE</td>
										<td>HEALTH</td>
										<th><a href="<?php echo base_url('project/view') ?>" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="View project"><i class="fas fa-eye"></i></a></th>
									</tr>
								</tbody>
							</table>
						</div>
