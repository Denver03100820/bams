	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="card card_min618">
			<div class="card-body">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<a href="<?php echo base_url('blotter/add') ?>" class="btn btn-sm btn-success"><i class="fas fa-plus-circle"></i> Add New Blotter</a>
					</div>
							...
							<table class="table table-hover">
								...
								<tbody>
									<tr>
										...
										<td>CLOSE</td>
										<th><a href="<?php echo base_url('blotter/view') ?>" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="View Blotter"><i class="fas fa-eye"></i></a></th>
									</tr>
								</tbody>
							</table>
						</div>
