...
<p class="text-indent">This is to certify that, <b><?php echo $name;?></b>, with given address located at <?php echo $address;?> has been given this Clearance/Certification for Aerial installation of <?php echo $porpose;?> of this Barangay from <?php echo $date; ?>.</p>
<p></p>
<p class="text-indent">This certification is issued to the Subject Company/Owner as a requirement for securing for the above cited purposes Only</p>
<p></p>
