            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 login-ct">
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 login-logo-ct">
                  ...
                  <center>
                    <h1 class="text-dark-custom ">LOG-IN</h1>
                  </center>
                  <!-- <hr> -->
                </div>
                <?php echo $form_url; ?>
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 login-logo-ct">
                  <div class="form-group">
                      <label class="text-dark-custom">USERNAME : </label>
                      <input type="text" name="username" class="form-control text-center" autocomplete="off" id="" placeholder="Enter Username" >
                  </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 login-logo-ct">
                  <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <a data-bs-toggle="modal" data-bs-target="#forgot_password" class="fgp-ct">Forgot Password?</a>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                      <center>
